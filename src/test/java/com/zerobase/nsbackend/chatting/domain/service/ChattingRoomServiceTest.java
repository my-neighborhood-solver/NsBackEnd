...
import static com.zerobase.nsbackend.chatting.dto.ChattingRoomCreateStatus.CHATTING_ROOM_CREATE_EXIST;
import static com.zerobase.nsbackend.chatting.dto.ChattingRoomCreateStatus.CHATTING_ROOM_CREATE_SUCCESS;
...
class ChattingRoomServiceTest {
  ...
  void testCreateChattingRoom1(){
    ...
    when(chattingRoomRepository.findByErrandAndSender(errand1, member2)).thenReturn(Optional.empty());
  ...
  void testCreateChattingRoom2(){
    ...
    when(chattingRoomRepository.findByErrandAndSender(errand1, member2)).thenReturn(Optional.of(ChattingRoom1));
