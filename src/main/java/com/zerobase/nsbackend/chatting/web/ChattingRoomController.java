...
public class ChattingRoomController {
  ...
  // 채팅방 단건 조회 && 조회시 읽음 처리
  @PutMapping("/{roomId}/memberId/{memberId}")
  ...
  // 채팅방 전체 안읽음 조회
  @GetMapping("/isNotRead/memberId/{memberId}")
  public ResponseEntity<?> getChattingRoomNotIsRead(@PathVariable Long memberId) {
    return ResponseEntity.ok().body(chattingRoomService.getAllNotIsRead(memberId));
  }
}